// Server-side managers: computed once at startup from the same parsed
// rows lib/seasons.js loads plus data/brewers_coaches.csv. Pure computation
...
const CSV = join(__dirname, '..', 'data', 'brewers_coaches.csv');
